...
#define HALL_DIGITAL_Pin GPIO_PIN_0
#define HALL_DIGITAL_GPIO_Port GPIOA
#define HALL_DIGITAL_EXTI_IRQn EXTI0_1_IRQn
#define HALL_ANALOG_Pin GPIO_PIN_1
#define HALL_ANALOG_GPIO_Port GPIOA
